    ...
    )
{
    ...
    case PixelFormat_RGBA4:    return 1;
...
//----------------------------------------------------------------
const char* PixelFormatUtil::toString(
    const PixelFormat aFormat
    )
{
    GLPicAssert( isValid( aFormat ) );
    ...
    case PixelFormat_RGBA_S3TC_DXT3: return "RGB_S3TC_DXT3";
    case PixelFormat_RGBA_S3TC_DXT5: return "RGB_S3TC_DXT5";
